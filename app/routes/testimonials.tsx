    ...
    <ScrollSnapContainer>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <SlideUpOnScroll delay={200}>
            <Text size="lg" muted className="max-w-2xl mx-auto">
              Hear from the realtors, buyers, and clients we've had the privilege to work with throughout South Florida.
            </Text>
          </SlideUpOnScroll>
        </div>
      </ScrollSection>
      ...
      <ScrollSection>
        ...
        <DecorativeElement position="center-right" opacity={0.25}>
          <Column size={250} color="var(--brand-navy)" />
        </DecorativeElement>
        <DecorativeElement position="bottom-left" opacity={0.25}>
          <Column size={250} color="var(--brand-gold)" />
        </DecorativeElement>
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <SlideUpOnScroll delay={100}>
            <Text className="mb-10 text-primary-foreground/80 text-lg">
              Let us help make your real estate transaction smooth and stress-free.
            </Text>
          </SlideUpOnScroll>
          <SlideUpOnScroll delay={200}>
